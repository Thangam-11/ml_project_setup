...
class FeatureEngineering:
    """
    Class for creating engineered features (without feature selection).
    """
    ...
    def __init__(self, data: pd.DataFrame, target_col="is_safe"):
        ...
        # WHO-like thresholds dictionary
        self.thresholds = {
            "aluminium": 2.8,
            "ammonia": 32.5,
            "arsenic": 0.01,
...
if __name__ == "__main__":
    try:
        ...
        final_data = fe.engineer_features(
            save_path=r"C:\Users\thang\Desktop\ml_project_seasion\data\pre_proceesed_data\processed_data.csv"
        )
